...
class Shipping extends \Magento\Checkout\Block\Total\DefaultTotal
{
     ...
     * @var string
     */
    protected $_template = 'Digitalriver_DrPay::checkout/shipping.phtml';
    ...
    public function getIncludeTaxLabel()
    {
        ...
        return $this->escapeHtml(__('Shipping Incl. Tax'));
    }
    ...
    public function getExcludeTaxLabel()
    {
        ...
        return $this->escapeHtml(__('Shipping Excl. Tax'));
    }
    ...
    public function getShippingDescription() {
        return $this->escapeHtml($this->getQuote()->getShippingAddress()->getShippingDescription());
    }
}
